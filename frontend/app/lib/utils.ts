...
import { CornerType, ElementConfigType, PositionType, SlideAnimationType, WalletAddress } from './types.js'
...
export function getDefaultData(): { default: ElementConfigType } {
  return {
      default: {
